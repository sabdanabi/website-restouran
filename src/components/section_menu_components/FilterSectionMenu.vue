    ...
    <div class="container mx-auto flex justify-between items-center">
      ...
      <div class="flex justify-between items-center gap-20">
        <ul class="hidden md:flex space-x-8 font-medium">
          <!-- Update the click handlers to call the methods defined in the script -->
          <li><button @click="$emit('filter')" class="style-filter-menu focus:text-electricBlue">Best Sellers</button></li>
          <li><button @click="$emit('filter')" class="style-filter-menu focus:text-electricBlue">All Menus</button></li>
